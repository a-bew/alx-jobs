...
const userResourceValidator = [
  body("firstName", "'firstName' must exceed 5 characters").isLength({
    min: 5,
  }),
  body("lastName", "'lastName' must exceed 5 characters").isLength({
    min: 5,
  }),
...
const optionalFieldsUserResourceValidator = [
  body("firstName", "'firstName' must exceed 5 characters").optional().isLength({
    min: 5,
  }),
  body("lastName", "'lastName' must exceed 5 characters").optional().isLength({
    min: 5,
  }),
...
export const validators = {
  ...
  updatePasswordValidationRules: [
    body("currentPassword", "'password' is required and must exceed 5 characters").isLength({ min: 5 }),
    body("newPassword", "'password' is required and must exceed 5 characters").isLength({ min: 5 }),
  ],
